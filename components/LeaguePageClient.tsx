...
import { toSlug, todayYMD, toYMD, dateFromYMD, fmtDate } from '@/lib/utils';
  ...
  return (
    <>
      ...
      <header className="league-hero">
        ...
        <Link href="/" className="btn-back" style={{ background: 'rgba(255,255,255,0.2)', borderColor: 'rgba(255,255,255,0.3)', flexShrink: 0 }}>
          ← Back
        </Link>
      </header>
        ...
        <div className="day-tabs-wrap" aria-label="Jump to day">
          <div className="day-tabs" role="tablist">
            {upcomingDays.map(({ ymd }) => (
              <a key={ymd} href={`#lday-${ymd}`} className="day-tab" role="tab">
                {shortLabel(ymd)}
              </a>
            ))}
          </div>
      ...
      {countryCount > 0 && (
        <>
          ...
          <div className="broadcast-grid" style={{ marginBottom: 28 }}>
      ...
      <section className="seo-section">
        ...
        <p>
          ...
          <strong>Bundesliga</strong>, <strong>Ligue 1</strong> and many more. Never miss a match.
        </p>
